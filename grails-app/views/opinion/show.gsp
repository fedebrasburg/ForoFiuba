...
<html>
    ...
    <body>
        ...
        <div id="show-opinion" class="content scaffold-show" role="main">
            ...
            <f:display bean="opinion" />
            <g:form resource="${this.opinion}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.opinion}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
